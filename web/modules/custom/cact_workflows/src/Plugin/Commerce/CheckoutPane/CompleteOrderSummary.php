...
namespace Drupal\cact_workflows\Plugin\Commerce\CheckoutPane;
 ...
 *   id = "complete_order_summary",
 *   label = @Translation("Complete order summary"),
 *   default_step = "_sidebar",
 *   wrapper_element = "container",
 * )
 */
class CompleteOrderSummary extends OrderSummary {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($view_storage->loadMultiple() as $view) {
      if (str_contains((string) $view->get('tag'), 'commerce_order_summary')) {
