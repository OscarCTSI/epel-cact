...
class CactOpenbravoEventSubscriber implements EventSubscriberInterface {
   ...
   */
  public function __construct(MessengerInterface $messenger, CactOpenbravoEntityHandler $cact_openbravo_entity_handler, CactOrderUtility $cact_order_utility, EntityTypeManagerInterface $entity_type_manager, OrderReceiptMailInterface $order_receipt_mail) {
