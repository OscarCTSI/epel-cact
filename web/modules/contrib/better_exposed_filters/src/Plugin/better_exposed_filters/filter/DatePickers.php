...
class DatePickers extends FilterWidgetBase {
  ...
  public function exposedFormAlter(array &$form, FormStateInterface $form_state) {
    ...
    $is_single_date = isset($element['value']['#type']) && $element['value']['#type'] == 'date_text';
    // Double Date-API-based input elements such as "in-between".
    //$is_double_date = isset($element['min'], $element['max']) && $element['min']['#type'] == 'date_text' && $element['max']['#type'] == 'date_text';
    $is_double_date = isset($element['min'], $element['max']) 
    && isset($element['min']['#type']) && $element['min']['#type'] == 'date_text' 
    && isset($element['max']['#type']) && $element['max']['#type'] == 'date_text';
