  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    if ($easy_email->hasField('key')) {
      $form['key'] = [
        ...
        '#access' => (bool) $formDisplay->getComponent('key'),
      ];
    }
    ...
    $form['to'] = [
      ...
      '#access' => $formDisplay->getComponent('recipient_address')
    ...
    $form['to']['recipient'] = [
      ...
      '#access' => (bool) $formDisplay->getComponent('recipient_address'),
    ];
    ...
    if ($easy_email->hasField('cc_address')) {
      $form['to']['cc'] = [
        ...
        '#access' => (bool) $formDisplay->getComponent('cc_address'),
      ];
    }
    ...
    if ($easy_email->hasField('bcc_address')) {
      $form['to']['bcc'] = [
        ...
        '#access' => (bool) $formDisplay->getComponent('bcc_address'),
      ];
    }
    ...
    if ($easy_email->hasField('from_name') || $easy_email->hasField('from_address') || $easy_email->hasField('reply_to')) {
      $form['sender'] = [
        '#type' => 'fieldset',
        '#title' => $this->t('Sender'),
        '#access' => $formDisplay->getComponent('from_name')
      ...
      if ($easy_email->hasField('from_name')) {
        $form['sender']['fromName'] = [
          ...
          '#access' => (bool) $formDisplay->getComponent('from_name'),
        ];
      }
      ...
      if ($easy_email->hasField('from_address')) {
        $form['sender']['fromAddress'] = [
          ...
          '#access' => (bool) $formDisplay->getComponent('from_address'),
        ];
      }
      ...
      if ($easy_email->hasField('reply_to')) {
        $form['sender']['replyToAddress'] = [
          ...
          '#access' => (bool) $formDisplay->getComponent('reply_to'),
        ];
      }
    }
    ...
    $form['content']['subject'] = [
      ...
      '#access' => (bool) $formDisplay->getComponent('subject'),
    ];
    ...
    if ($easy_email->hasField('body_html')) {
      $form['body_html'] = [
        ...
        '#group' => 'body',
        '#access' => $formDisplay->getComponent('body_html')
      ...
      $form['body_html']['bodyHtml'] = [
        ...
        '#access' => (bool) $formDisplay->getComponent('body_html'),
    ...
    if ($easy_email->hasField('body_html') && $easy_email->hasField('inbox_preview')) {
      $form['body_html']['inboxPreview'] = [
        ...
        '#access' => (bool) $formDisplay->getComponent('inbox_preview'),
      ];
    }
    ...
    if ($easy_email->hasField('body_plain')) {
      $form['body_plain'] = [
        ...
        '#group' => 'body',
        '#access' => (bool) $formDisplay->getComponent('body_plain'),
      ];
    ...
    if ($easy_email->hasField('attachment_path')) {
      $form['content']['attachment'] = [
        ...
        '#access' => (bool) $formDisplay->getComponent('attachment_path'),
      ];
    }
    ...
    if ($easy_email->hasField('attachment')) {
      $form['content']['saveAttachment'] = [
        ...
        '#access' => (bool) $formDisplay->getComponent('attachment'),
      ];
